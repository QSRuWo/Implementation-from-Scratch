...
class PositionWiseFFN(nn.Module):
    def __init__(self, ffn_num_input, ffn_hidden_size, ffn_num_output, **kwargs):
        super(PositionWiseFFN, self).__init__(**kwargs)
        self.dense_1 = nn.Linear(ffn_num_input, ffn_hidden_size)
        self.relu = nn.ReLU()
        self.dense_2 = nn.Linear(ffn_hidden_size, ffn_num_output)
...
class EncoderBlock(nn.Module):
    ...
    Define Encoder
    '''
    def __init__(self, key_size, query_size, value_size, hidden_size, norm_shape, ffn_num_input, ffn_hidden_size, num_heads, dropout, use_bias=False, **kwargs):
